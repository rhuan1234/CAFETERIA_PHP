...
$ProdutoAtualizado = new Produto(
    ...
    $ProdutoAtualizado->setImagem("img/".uniqid().$_FILES['imagem']['name']);
    move_uploaded_file($_FILES['imagem']['tmp_name'], $ProdutoAtualizado->getImagem());
        }
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="container-radio">
        <div>
            ...
            <input type="radio" id="cafe" name="tipo" value="Bebida" <?= $produto->getTipo() === 'Bebida' ? 'checked' : '' ?>>
        </div>
        <div>
            <label for="almoco">Almoço</label>
            <input type="radio" id="almoco" name="tipo" value="Prato" <?= $produto->getTipo() === 'Prato' ? 'checked' : '' ?>>
        </div>
    </div>
