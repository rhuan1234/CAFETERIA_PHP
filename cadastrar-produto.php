...
if(isset($_POST['cadastrar'])){
    ...
    $produto->setImagem("img/".uniqid().$_FILES['imagem']['name']);
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="container-radio">
                <div>
                    ...
                    <input type="radio" id="cafe" name="tipo" value="Bebida" checked>
                </div>
                <div>
                    <label for="almoco">Almoço</label>
                    <input type="radio" id="almoco" name="tipo" value="Prato">
                </div>
            </div>
            ...
            <input name="cadastrar" type="submit" name="cadastro" class="botao-cadastrar" value="Cadastrar produto"/>
        </form>
